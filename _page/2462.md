...
Are you new to Paleography? On this page you can familiarize yourself with basic characteristics of the main scripts of early Italian vernacular texts (most common abbreviations and letter forms) and make your own first transcriptions.</p>

### <a id="Gothic" name="Gothic"></a>Gothic</h2>
...
For more information see our <a href="/content/abbreviations" style="font-weight:normal">Abbreviations</a> and <a href="/content/symbols-punctuations">Symbols & Punctuation</a> pages.</p>
...
<td><l>f <img alt="" src="/sites/default/files/gothic-letter-f.png" style="width: 35px; height: 55px;" />*     *l <img alt="" src="/sites/default/files/gothic-letter-l.png" style="width: 21px; height: 55px;" />     s <img alt="" src="/sites/default/files/gothic-letter-s1.png" style="width: 28px; height: 55px;" /></l></td>
...
<td><l>m, n *<img alt="" src="/sites/default/files/gothic-animo.png" style="width: 135px; height: 33px;" /> *animo</l></td>
</tr></tbody></table>
#### Try transcribing a few lines!</h4>

Example 1 (Newberry VAULT Case MS 219, f.48r):</p>

<a href="/sites/default/files/gothic1-ms_219-48r.jpg" target="_top"><img alt="Example 1 (Newberry VAULT Case MS 219, f.48r):" src="/sites/default/files/gothic1-ms_219-48r.jpg" style="width: 889px; height: 380px;" /></a></p>

<button class="expand-content" data-target="paleo1">+ See transcription</button><button class="collapse-content" data-target="paleo1">- Hide transcription</button></p>
...
Example 2 (Newberry VAULT Case MS 79, f.56v):</p>

<a href="/sites/default/files/gothic2-ms79-f.56v.jpg" target="_top"><img alt="Example 2 (Newberry VAULT Case MS 79, f.56v):" src="/sites/default/files/gothic2-ms79-f.56v.jpg" style="width: 885px; height: 185px;" /></a></p>

<button class="expand-content" data-target="paleo2">+ See transcription</button><button class="collapse-content" data-target="paleo2">- Hide transcription</button></p>
...
 </p>
<hr />
### <a id="Cancelleresca" name="Cancelleresca"></a>Cancelleresca</h2>

The *cancelleresca* was a script typical of public (papal, imperial, regal or noble chancellery) and private (notarial) documents and was characterized by a cursive line. For more information about the characteristics and the history of the cancelleresca script see our <a href="/handbook">Handbook</a> page.</p>
...
Example 1 (Morgan MS M.289, f.1v):</p>

<a href="/sites/default/files/cancelleresca-1.png" target="_top"><img alt="Example 1 (Morgan MS M.289, f.1v):" src="/sites/default/files/cancelleresca-1.png" style="width: 554px; height: 263px;" /></a></p>

<button class="expand-content" data-target="paleo3">+ See transcription</button><button class="collapse-content" data-target="paleo3">- Hide transcription</button></p>
...
Example 2 (UPenn MS 273, f.1r):</p>

<a href="/sites/default/files/cancelleresca-2.png" target="_top"><img alt="Example 2 (UPenn MS 273, f.1r):" src="/sites/default/files/cancelleresca-2.png" style="width: 641px; height: 700px;" /></a></p>

<button class="expand-content" data-target="paleo3b">+ See transcription</button><button class="collapse-content" data-target="paleo3b">- Hide transcription</button></p>
...
 </p>
<hr />
### <a id="Mercantesca" name="Mercantesca"></a>Mercantesca</h2>
...
Example 1 (Newberry VAULT oversize Case MS 27, f.1v):</p>

<a href="/sites/default/files/mercantesca-1.png" target="_top"><img alt="Example 1 (Newberry VAULT oversize Case MS 27, f.1v):" src="/sites/default/files/mercantesca-1.png" style="width: 865px; height: 371px;" /></a></p>

<button class="expand-content" data-target="paleo4">+ See transcription</button><button class="collapse-content" data-target="paleo4">- Hide transcription</button></p>
...
Example 2 (UPenn MS 1535, f.13v):</p>

<a href="/sites/default/files/mercantesca-2.png" target="_top"><img alt="Example 2 (UPenn MS 1535, f.13v):" src="/sites/default/files/mercantesca-2.png" style="width: 854px; height: 275px;" /></a></p>

<button class="expand-content" data-target="paleo4b">+ See transcription</button><button class="collapse-content" data-target="paleo4b">- Hide transcription</button></p>
...
 </p>
<hr />
### <a id="Humanistic" name="Humanistic"></a>Humanistic</h2>

The humanistic script first developed by a restricted Florentine cultural elite and later became the common script of scholars and nobleman. For more information about the characteristics and the history of the humanistic script see our <a href="/handbook">Handbook</a> page.</p>

#### Try transcribing a few lines!</h4>

Example 1 (Newberry VAULT slipcase Ayer MS map 1, f.5r):</p>

<a href="/sites/default/files/humanistic-1.png" target="_top"><img alt="Example 1 (Newberry VAULT slipcase Ayer MS map 1, f.5r):" src="/sites/default/files/humanistic-1.png" style="width: 585px; height: 321px;" /></a></p>

<button class="expand-content" data-target="paleo5">+ See transcription</button><button class="collapse-content" data-target="paleo5">- Hide transcription</button></p>
...
Example 2 (Newberry VAULT Case MS 151, f.74v):</p>

<a href="/sites/default/files/humanistic-2.png" target="_top"><img alt="Example 2 (Newberry VAULT Case MS 151, f.74v):" src="/sites/default/files/humanistic-2.png" style="width: 885px; height: 257px;" /></a></p>

<button class="expand-content" data-target="paleo6">+ See transcription</button><button class="collapse-content" data-target="paleo6">- Hide transcription</button></p>
...
 </p>
<hr />
### <a id="Italic" name="Italic"></a>Italic</h2>

The Italic script was a humanistic minuscule, semi-cursive hand. It would later be further develop with the invention of print and movable types. For more information about the characteristics and the history of the Italic script see our <a href="/handbook">Handbook</a> page.</p>

#### Try transcribing a few lines!</h4>

Example 1 (Newberry VAULT MS 6A 29, f.25r):</p>

<a href="/sites/default/files/italic-1.png" target="_top"><img alt="Example 1 (Newberry VAULT MS 6A 29, f.25r):" src="/sites/default/files/italic-1.png" style="width: 600px; height: 324px;" /></a></p>

<button class="expand-content" data-target="paleo7">+ See transcription</button><button class="collapse-content" data-target="paleo7">- Hide transcription</button></p>
...
Example 2 (Newberry VAULT Case MS 5086, vol. 1 f.180r):</p>

<a href="/sites/default/files/italic-2.png" target="_top"><img alt="Example 2 (Newberry VAULT Case MS 5086, vol. 1 f.180r):" src="/sites/default/files/italic-2.png" style="width: 582px; height: 105px;" /></a></p>

<button class="expand-content" data-target="paleo8">+ See transcription</button><button class="collapse-content" data-target="paleo8">- Hide transcription</button></p>
...
Example 3 (Newberry VAULT Case MS folio F 3593 .31, f.1v):</p>

<a href="/sites/default/files/italic-3.png" target="_top"><img alt="Example 3 (Newberry VAULT Case MS folio F 3593 .31, f.1v):" src="/sites/default/files/italic-3.png" style="width: 885px; height: 250px;" /></a></p>

<button class="expand-content" data-target="paleo9">+ See transcription</button><button class="collapse-content" data-target="paleo9">- Hide transcription</button></p>
...
Now, you are ready to go to our <a href="https://italian-paleography-dev.library.utoronto.ca/islandora/search">Manuscript</a> page, explore more texts and start practicing with more transcriptions!</p>
"
